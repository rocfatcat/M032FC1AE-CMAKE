...
IROM2_SECTION int FMC_Proc(unsigned int u32Cmd, unsigned int addr_start, unsigned int addr_end, unsigned int *data)
{
...
IROM2_SECTION void UpdateConfig(unsigned int *data, unsigned int *res)
{

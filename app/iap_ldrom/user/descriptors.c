...
const uint8_t *gpu8UsbString[4] __attribute__((section(".rodata_ptr8"), aligned(4), used)) =
{
    gu8StringLang,
    gu8VendorStringDesc,
...
const uint32_t gu32UsbHidReportLen[3] __attribute__((section(".rodata_ptr32"), aligned(4), used)) =
{
...
const uint32_t gu32ConfigHidDescIdx[3] __attribute__((section(".rodata_ptr32"), aligned(4), used)) =
{

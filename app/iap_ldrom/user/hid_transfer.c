...
IROM2_SECTION void EP2_Handler(void)  /* Interrupt IN handler */
{
    uint8_t *ptr;
...
IROM2_SECTION void EP3_Handler(void)  /* Interrupt OUT handler */
{
    uint8_t *ptr;
    /* Interrupt OUT */
...
/**
  ...
  * @retval None.
  */
IROM2_SECTION void HID_Init(void)
{
...
IROM2_SECTION void HID_ClassRequest(void)
{
    uint8_t buf[8];
